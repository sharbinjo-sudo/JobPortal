# Generated by Django 5.2.17 on 2026-09-25 07:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='portal.application')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_mode', models.CharField(choices=[('REMOTE', 'Remote'), ('HYBRID', 'Hybrid'), ('ONSITE', 'On-site')], default='HYBRID', max_length=20)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='jobs', to='portal.company')),
                ('recruiter', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='jobs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            ...
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='applications', to='portal.job'),
        ),
        migrations.CreateModel(
            name='SeekerProfile',
            fields=[
        ...
        migrations.AddIndex(
            model_name='job',
            index=models.Index(fields=['status', 'created_at'], name='portal_job_status_cf7458_idx'),
        ),
        migrations.AddIndex(
            model_name='job',
            index=models.Index(fields=['location', 'employment_type'], name='portal_job_locatio_f1bf6f_idx'),
        ),
